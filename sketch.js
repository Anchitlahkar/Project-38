...
function setup(){
    ...
    Wall = createSprite(windowWidth/2,10,windowWidth,30)
    Wall.visible=false
...
function draw() {
    ...
    text("PowerJump = "+powerJump,player.x+200,Ground.y-450)  
    text("Survivel Time: "+ score+" sec", player.x+400,Ground.y-450);
